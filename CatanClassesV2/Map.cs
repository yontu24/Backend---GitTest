...
namespace Catan
{
    class Map
    {
        ...
        {
            /*nodes[1].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[2].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[3].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[4].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[5].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[6].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[7].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[8].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[9].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[10].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[11].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[12].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[13].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[14].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[15].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[16].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[17].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[18].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[19].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[20].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[21].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[22].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[23].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[24].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[25].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[26].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[27].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[28].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[29].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[30].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[31].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[32].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[33].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[34].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[35].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[36].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[37].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[38].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[39].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[40].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[41].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[42].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[43].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[44].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[45].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[46].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[47].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[48].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[49].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[50].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[51].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[52].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[53].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };
            nodes[54].NodeNeighbors = new List<Node> { nodes[], nodes[], nodes[] };*/
        }
